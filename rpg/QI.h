...
#define MAX_ARTIFACT_SLOTS 4
#define MAX_ARTIFACT_LEVEL 6
#define MAX_ELIXIR_SLOTS 6
#define REWARD_CHOICE_COUNT 3
#define MAX_TALENTS 8
#define MAX_ALCHEMY_RECIPES 16
...
typedef enum {
    ...
    // 流派补齐
    SKILL_ID_KINDLE_ART,
    SKILL_ID_SCARLET_FLAME_GUARD,
    SKILL_ID_PALM_THUNDER,
    SKILL_ID_THUNDER_ESCAPE_STEP,
    SKILL_ID_SOUL_GRASP_CURSE,
    SKILL_ID_SHADOW_QI_RETURN,
    SKILL_ID_GREEN_WOOD_BREATH,
    SKILL_ID_REJUVENATE_DETOX,
    SKILL_ID_IRON_BONE_ART,
    SKILL_ID_BLACK_ARMOR_REBOUND,
    SKILL_ID_MICROCOSMIC_ORBIT,
    SKILL_ID_RETURN_TO_ORIGIN,
    CUSTOM_SKILL_START,
...
typedef enum {
    ...
    ARTIFACT_SCARLET_SUN_FURNACE,
    ARTIFACT_SOUL_BELL,
    ARTIFACT_GREEN_WOOD_TABLET,
    ARTIFACT_THUNDER_JADE,
    ARTIFACT_HUNDRED_REFINED_MIRROR,
...
typedef enum {
    ...
    ELIXIR_MERIDIAN_GUARD,
    ELIXIR_FOCUS_INSIGHT,
    ELIXIR_EXORCISM,
    ELIXIR_WOOD_SPIRIT,
    CUSTOM_ELIXIR_START,
...
typedef struct Player_s {
    ...
    int herb_materials;
    bool unlocked_alchemy_recipes[MAX_ALCHEMY_RECIPES];
